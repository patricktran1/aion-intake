...
export const GOLDEN_CASES: EvalCase[] = [
  ...
  },
  {
    ...
    assert: {
      ...
      expectClarify: ["two different timelines"],
    },
  },
  {
    id: "rash-consistent-timeline-no-flag",
    expectPathway: "rash",
    opening: "I have an itchy rash that started about six months ago",
    answers: {
      location: "My back",
      timeline: "About six months, staying the same",
      symptoms: "Itchy",
      triggers: "No",
      exposures: "No",
      treatments: "Hydrocortisone, helped a little then stopped working",
      atopy: "No",
      context: "No",
      goal: "Fix it",
    },
    probes: "A CONSISTENT timeline must not trip the contradiction flag (false-positive guard).",
    tags: ["rash", "contradiction-negative"],
    assert: {
      prohibited: [/two different timelines/i],
    },
  },
  {
    id: "lesion-unsure-vs-skipped",
    expectPathway: "lesion",
    opening: "A dark spot on my shin I want looked at",
    answers: {
      location: "Right shin",
      lesion_timeline: "honestly no idea",
      lesion_symptoms: "It doesn't bleed or itch",
      sun_history: "Some sun over the years",
      lesion_others: "No",
      treatments: "Nothing",
      context: "No medications",
      goal: "Peace of mind",
    },
    probes: "'No idea' (asked — did not know) and a skip (asked — skipped) must stay distinguishable in clarify, and neither may read as a negative.",
    tags: ["lesion", "negative-vs-unknown"],
    assert: {
      expectClarify: ["did not know"],
      prohibited: [/\bdenies\b/i],
    },
  },
  {
    id: "rash-vague-poor",
